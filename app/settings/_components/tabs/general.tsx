...
import { SlidersHorizontal, Settings, TriangleAlert } from "lucide-react";
...
export default function General() {
  ...
  return (
    <div className="space-y-3">
      ...
      <SectionBlock title="Coin Profile" icon={<SlidersHorizontal size={16} className="text-white/70" />}>
        <Row cols={3}>
...
<div className="bg-white/5 border border-white/10 rounded-lg p-4">
  ...
  <div className="text-xs text-white/70 mt-3">
    This will disable all active flywheels. You'll need to reconfigure and sign transactions for each one
  </div>
</div>
{/* --- End: Danger Zone --- */}
...
{/* --- OPTIONAL --- */}
{/* Add a "Reset" button at the end of the form with "Save" */}
{/* Make sure this is at the end of your <General> component */}
