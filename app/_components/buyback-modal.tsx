...
export function BuybackModal({
  ...
  }, [isSuccess, isProcessing, allocation, onComplete, onClose]);
  ...
  const handleSignAndActivate = async () => {
    try {
      ...
      await sendCommitment("Configure Buyback");
      ...
      <div className="fixed inset-0 flex items-center justify-center z-50 p-4">
        <div className="bg-[#0B1424] border border-white/10 rounded-2xl w-full max-w-md shadow-2xl">
          ...
          <div className="flex items-center justify-between px-6 py-5 border-b border-white/10">
            <h2 className="text-white font-semibold text-lg">Buybacks</h2>
            <button
              onClick={handleCancel}
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="text-white">Buybacks</span>
                    </div>
                    <div className="flex justify-between text-sm">
            ...
            {step === "configure" && (
              <>
                ...
                <Button
                  ...
                  className="flex-1"
                  disabled={!allocation || parseFloat(allocation) <= 0}
                >
                  Continue
                </Button>
              </>
